 ...
 *
 * Requête 23 - Request 23
 */
 
//Intitulé
echo '<span class="btn btn-secondary mt-2"><strong>23. Collection : Collaborations internationales (institutions)</strong></span><br><br>';
...
for ($year = $anneedeb; $year <= $anneefin; $year++) {
	if (stripos($team, 'IDHAL:') !== false) {
		...
		$url = $cstAPI."?fq=authIdHal_s:".$idHAL."&producedDateY_i:".$year."&fl=docType_s,structName_s,structType_s,halId_s,structCountry_s&rows=10000";
	}else{
