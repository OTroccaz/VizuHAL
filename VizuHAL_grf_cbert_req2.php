...
function grf_cbert($year, $resHAL, $team, $ficgraf, $orig) {
  ...
  $nbnoTInoOA = $nbnoTI - $nbnoTIavOA;
	...
	if (strpos(phpversion(), "7") !== false) {//PHP7 > pChart2
		...
		$myPicture->myData->addPoints([$nbavTI, $nbnoTInoOA, $nbnoTIavOA],"Detail");
		$myPicture->myData->setSerieDescription("Detail","Application A");

		/* Define the absissa serie */
		$myPicture->myData->addPoints(["Avec TI", "Sans TI sans OA", "Sans TI avec OA"],"Labels");
		...
		$MyData->addPoints(array($nbavTI, $nbnoTInoOA, $nbnoTIavOA),"Detail");
		$MyData->setSerieDescription("ScoreA","Application A");//?

		/* Define the absissa serie */
		$MyData->addPoints(array("Avec TI", "Sans TI sans OA", "Sans TI avec OA"),"Labels");
