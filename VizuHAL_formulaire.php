                                                ...
                                                <div class="col-12 col-md-9">
                                                    <div class="input-group">
                                                        <div class="input-group-prepend">
                                                            <button type="button" tabindex="0" class="btn btn-info" data-html="true" data-toggle="popover" data-trigger="focus" title="" data-content='Code visible dans l&apos;URL d&apos;une collection.<br>
                                            Exemple IPR-MOL est le code de la collection http://hal.archives-ouvertes.fr/ <span class="font-weight-bold">IPR-PMOL</span> de l&apos;équipe Physique moléculaire de l&apos;unité IPR UMR CNRS 6251<br><br>
											Pour les requêtes 17 à 23, vous avez également la possibilité d&apos;interroger un idHAL en renseignant le champ sous la forme <span class="font-weight-bold">IDHAL:OLIVIER-TROCCAZ</span>' data-original-title="">
																													...
																													if ($reqt == $cstR02) {
																														...
																														if ($reqt == $cstR01) {
																															...
																															if ($reqt == $cstR03) {
																																...
																																$limReq3 = (isset($_POST["limReq3"])) ? 'oui' : 'non';
																															}else{
																																if ($reqt == $cstR04) {
																																										...
																																										if ($reqt == $cstR14) {
																																											...
																																											if ($reqt == $cstR15) {
																																												...
																																												if ($reqt == $cstR16) {
																																													...
																																													if ($reqt == $cstR17) {
																																														$anneedeb = htmlspecialchars($_POST["anneedeb17"]);
																																														$anneefin = htmlspecialchars($_POST["anneefin17"]);
																																													}else{
																																														if ($reqt == $cstR18) {
																																																		...
																																																		if ($reqt == $cstR22) {
																																																			...
																																																			if ($reqt == $cstR24) {
																																																				...
																																																				if ($reqt == $cstR25) {
																																																					...
																																																					if ($reqt == $cstR26) {
																																																						$anneedeb = htmlspecialchars($_POST["anneedeb26"]);
																																																						$anneefin = htmlspecialchars($_POST["anneefin26"]);
																																																						if ($anneefin < $anneedeb) {$anneetemp = $anneedeb; $anneedeb = $anneefin; $anneefin = $anneetemp;}
																																																					}else{
                                            ...
                                            <div class="form-group row mb-1">
																						...
																						<div class="form-group row mb-1">
																								...
																								<select class="custom-select col-sm-4" id="port" name="port" onChange="document.getElementById('team').value = '';">
																										...
																										while (false !== ($fichier = readdir($dossier))) {
																											if($fichier != '.' && $fichier != '..' && strpos($fichier, 'VizuHAL_PortHAL') !== false && $fichier != 'VizuHAL_PortHAL-RENNES_av2020.php') {
                                                ...
                                                <div class="col-12">
                                                    <h3 class="d-inline-block">&nbsp;</h3>
																						...
																						if (isset($reqt) && $reqt == $cstR26) {$irq26 = $cstSel;}else{$irq26 = "";}
																						?>
																						...
																						<div class="form-group" id="<?php echo $cstR17;?>">
																							<div class="form-group row mb-1">
																								<!--Paramètres :-->
																								<label for="anneedeb17" class="col-12 col-md-3 col-form-label font-weight-bold">Période</label>
																								<span class="mt-1">Depuis&nbsp;</span>
																								<select id="anneedeb17" class="custom-select col-sm-1" name="anneedeb17">
																								<?php
																								$moisactuel = date('n', time());
																								if ($moisactuel >= 10) {$i = date('Y', time())+1;}else{$i = date('Y', time());}
																								while ($i >= date('Y', time()) - 30) {
																								...
																								<label for="anneefin17" class="col-12 col-md-1 col-form-label font-weight-bold"></label>
																								<span class="mt-1">Jusqu'à&nbsp;</span>
																								<select id="anneefin17" class="custom-select col-sm-1" name="anneefin17">
																								<?php
																								$moisactuel = date('n', time());
																								if ($moisactuel >= 10) {$i = date('Y', time())+1;}else{$i = date('Y', time());}
																								while ($i >= date('Y', time()) - 30) {
																						...
																						<!--Requête 26-->
																						<div class="form-group" id="<?php echo $cstR26;?>">
																							<div class="form-group row mb-1">
																								<!--Paramètres :-->
																								<label for="anneedeb26" class="col-12 col-md-3 col-form-label font-weight-bold">Période</label>
																								<span class="mt-1">Depuis&nbsp;</span>
																								<select id="anneedeb26" class="custom-select col-sm-1" name="anneedeb26">
																								<?php
																								$moisactuel = date('n', time());
																								if ($moisactuel >= 10) {$i = date('Y', time())+1;}else{$i = date('Y', time());}
																								while ($i >= date('Y', time()) - 30) {
																								...
																								<label for="anneefin26" class="col-12 col-md-1 col-form-label font-weight-bold"></label>
																								<span class="mt-1">Jusqu'à&nbsp;</span>
																								<select id="anneefin26" class="custom-select col-sm-1" name="anneefin26">
																								<?php
																								$moisactuel = date('n', time());
																								if ($moisactuel >= 10) {$i = date('Y', time())+1;}else{$i = date('Y', time());}
																								while ($i >= date('Y', time()) - 30) {
