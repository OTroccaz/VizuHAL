 ...
 *
 * Requête 20 - Request 20
 */
 
//Intitulé
echo '<span class="btn btn-secondary mt-2"><strong>20. Collection : Collaborations nationales (autres)</strong></span><br><br>';
...
if ($totColl != 0) {//Au moins 1 résultat
	...
	*/
	...
	echo '<a class="btn btn-secondary mt-2" href="./csv/req20.csv">Exporter le tableau au format CSV</a><br><br>';
}else{
	echo $cstNR;
}
?>