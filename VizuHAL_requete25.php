 ...
 *
 * Requête 2A - Request 2A
 */
 
//Intitulé
echo '<span class="btn btn-secondary mt-2"><strong>2A. Portail ou collection : évolution sur une période (Articles de revue)</strong></span><br><br>';
...
echo '<a class="btn btn-secondary mt-2" href="./csv/req25.csv">Exporter le tableau au format CSV</a><br><br>';
?>