 ...
 *
 * Requête 18 - Request 18
 */
 
//Intitulé
echo '<span class="btn btn-secondary mt-2"><strong>18. Collection : Collaborations nationales (laboratoires)</strong></span><br><br>';

//Descriptif
echo '<div class="alert alert-secondary">Cette requête affiche, pour une collection, la liste des unités de recherche françaises auxquelles sont affiliés des co-auteurs. La requête est basée sur les tampons de collections (collCode_s). <a href="#DT">Voir détails techniques en bas de page</a>.</div><br>';
...
if ($totColl != 0) {//Au moins 1 résultat
	...
	*/
	...
	echo '<a class="btn btn-secondary mt-2" href="./csv/req18.csv">Exporter le tableau au format CSV</a><br><br>';
}else{
	echo $cstNR;
}
?>